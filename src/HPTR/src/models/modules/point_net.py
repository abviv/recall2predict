...
class PointNet(nn.Module):
    ...
    def forward(self, x: Tensor, valid: Tensor) -> Tuple[Tensor, Tensor]:
        ...
        In this [n_batch, n_pl, n_pl_node, attr_dim], n_pl means the number of polylines which 
        we have control over within the cfg. n_pl_node defines how many n_pl is represented to define
        a single polyline. Typically there are 20 nodes defining each of the n_pl. And the attr_dim
        defines the features which we are using to build that n_pl_node. 
